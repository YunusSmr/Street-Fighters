...
screen.bgpic("Gif//StreetFighterBg.gif")
...
def P():
    global Health_Bar2
    Ryu_fight = "Gif//Ryu_fighting.gif"
...
def G():
    global Health_Bar1
    Guile_rkick = "Gif//Guile_flashkick.gif"
